library(tidyverse)
library(rlist)
library(Rgctc2,lib.loc='F:/Administrator/Documents/GitHub/R_coordination_transformation')
library(sf)
library(httr)
library(jsonlite)
...
#
js_city<-get_location('江苏')[['districts']] %>% "["('districts') %>% '[['(1) %>% '[['(1)
